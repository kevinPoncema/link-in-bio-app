...
const LinkCreate = ({ 
  ...
  const modalContent = (
    <>
      {/* Backdrop + container with scroll to avoid clipping on small screens */}
      <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[9999] p-4 overflow-y-auto">
        <div className="bg-gray-800 rounded-2xl max-w-md w-full border border-gray-700 shadow-2xl my-8">
          {/* Header */}
